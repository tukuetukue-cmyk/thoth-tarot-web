...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderResult(cards, context, spreadType, readingResult) {
            ...
            <div class="result-card ${spreadType === 'three_card' ? 'three-card-result' : ''}">
                ...
                <div class="reading-content">
                    ...
                    <div class="result-actions">
                        ...
                        <button id="go-sephiroth-btn" class="mystic-btn restart-btn" style="display:flex; align-items:center; justify-content:center; border:1px solid var(--accent-gold); box-shadow: 0 0 8px rgba(212, 175, 55, 0.4);">${t('result.btn_sephiroth')}</button>
        ...
        document.getElementById('go-sephiroth-btn').addEventListener('click', () => {
            const recentReading = {
                theme: context || t('result.no_theme'),
                spread_type: spreadType,
                cards: cards,
            ...
            localStorage.setItem('recent_reading', JSON.stringify(recentReading));
            sessionStorage.setItem('recent_reading', JSON.stringify(recentReading));
            window.location.href = `tree-of-life.html?cards=${drawnCardIds}`;
        });
